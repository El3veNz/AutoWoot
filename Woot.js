...
bpl = {
    ...
    doubleClick: function() { bpl.clicks++; if (bpl.clicks == 2) { bpl.autowoot = !bpl.autowoot; bpl.clicks = 0; _$context.trigger('notify', 'icon-woot', bpl.autowoot ? 'AutoWoot est maintenant activé' : 'AutoWoot est maintenant etteint'); } setTimeout(function() { bpl.clicks = 0 }, 600)}
    }
